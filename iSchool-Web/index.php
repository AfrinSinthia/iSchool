...
<div class="img" style="position: relative; overflow: hidden;">
  <video autoplay muted loop playsinline
         style="width: 100%; height: 100%; object-fit: cover; z-index: 2; position: relative;">
    <source src="video/banvid.webm" type="video/webm">
...
<!-- End Video Background -->
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          ...
          <div class="col-sm">
            <h5><i class="fas fa-wallet mr-3"></i> Money Back Guarantee*</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
            ...
            <a href="coursedetails.php?course_id='.$course_id.'" class="btn" style="text-align: left; padding:0px; margin:0px;">
              <div class="card">
                ...
                <div class="card-footer">
                  <p class="card-text d-inline">Price: <small><del><b>&#2547</b> '.$row['course_original_price'].'</del></small> <span class="font-weight-bolder"><b>&#2547</b> '.$row['course_price'].'<span></p> <a class="btn btn-primary text-white font-weight-bolder float-right" href="coursedetails.php?course_id='.$course_id.'">Enroll</a>
                </div>
              </div>
            </a>  ';
          }
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Sinthia Afrin <br> Patuakhali Science & Technology University <br> Dumki, Patuakhali <br> Ph. +880 1746-657000 </p>
          </div>
        </div>
      </div>
