          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  <p class="card-text d-inline">Price: <small><del><b>&#2547</b> <?php echo $row['course_original_price'] ?> </del></small> <span class="font-weight-bolder"><b>&#2547</b> <?php echo $row['course_price']?> <span></p>
