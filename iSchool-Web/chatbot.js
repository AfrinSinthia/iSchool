...
document.getElementById('chat-form').addEventListener('submit', async function(event) {
    ...
    try {
        const firebaseUrl =`https://chatbot-154d8-default-rtdb.firebaseio.com/api_data/${encodeURIComponent(messageText)}.json`;
        ...
        if (firebaseData && firebaseData.answer) {
            ...
            const apiResponse = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyBqQ97x1oSRpAjcHB_B5mFLqA3BnMgQ2ZI", {
                method: "POST",
                headers: {
